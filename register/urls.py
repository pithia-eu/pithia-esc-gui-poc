...
urlpatterns = [
    ...
    path('acquisition-capability/', views.acquisition.as_view(), name='acquisition_capability'),
    path('acquisition/', views.acquisition.as_view(), name='acquisition'),
    path('computation-capability/', views.computation.as_view(), name='computation_capability'),
