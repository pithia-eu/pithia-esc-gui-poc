...
urlpatterns = [
    ...
    path('acquisition-capability/', views.acquisitions.as_view(), name='acquisition_capability'),
    path('acquisition/', views.acquisition.as_view(), name='acquisition'),
    path('computation-capability/', views.computations.as_view(), name='computation_capability'),
