...
urlpatterns = [
    ...
    path('acquisition-capability/', views.AcquisitionCapabilitiesRegisterFormView.as_view(), name='acquisition_capability'),
    path('acquisition/', views.AcquisitionRegisterFormView.as_view(), name='acquisition'),
    path('computation-capability/', views.ComputationCapabilitiesRegisterFormView.as_view(), name='computation_capability'),
