...
urlpatterns = [
    ...
    path('acquisition-capabilities/<acquisition_capability_id>/delete/', views.AcquisitionCapabilitiesDeleteView.as_view(), name='acquisition_capability_set'),
    path('acquisitions/<acquisition_id>/delete/', views.AcquisitionDeleteView.as_view(), name='acquisition'),
    path('computation-capabilities/<computation_capability_id>/delete/', views.ComputationCapabilitiesDeleteView.as_view(), name='computation_capability_set'),
