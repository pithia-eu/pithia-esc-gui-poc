...
urlpatterns = [
    ...
    path('data-collections/<data_collection_id>/api/delete/', views.DataCollectionDeprecatedInteractionMethodDeleteView.as_view(), name='data_collection_interaction_method'),
