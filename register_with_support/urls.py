...
urlpatterns = [
    ...
    path('static-dataset-entry-wizard/', views.CatalogueEntryRegisterWithEditorFormView.as_view(), name='static_dataset_entry_with_editor'),
    path('data-subset-wizard/', views.CatalogueDataSubsetRegisterWithEditorFormView.as_view(), name='data_subset_with_editor'),
