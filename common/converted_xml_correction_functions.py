...
def correct_operation_xml_converted_to_dict(self, dictionary):
    # Check if relatedParty property is an
    # array-type property
    if 'relatedParty' in dictionary and not isinstance(dictionary['relatedParty'], list):
        dictionary['relatedParty'] = [dictionary['relatedParty']]
...
def correct_instrument_xml_converted_to_dict(self, dictionary):
...
def correct_acquisition_capability_set_xml_converted_to_dict(self, dictionary):
...
def correct_acquisition_xml_converted_to_dict(self, dictionary):
...
def correct_computation_capability_set_xml_converted_to_dict(self, dictionary):
    # Check if the 'processCapability' property is an
    # array-type property
    if 'capabilities' in dictionary and 'processCapability' in dictionary['capabilities'] and not isinstance(dictionary['capabilities']['processCapability'], list):
        dictionary['capabilities']['processCapability'] = [dictionary['capabilities']['processCapability']]
...
def correct_process_xml_converted_to_dict(self, dictionary):
...
def correct_data_collection_xml_converted_to_dict(self, dictionary):
