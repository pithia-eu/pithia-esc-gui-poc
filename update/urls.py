...
urlpatterns = [
    ...
    path('catalogue-entries/<resource_id>/update', views.CatalogueEntryUpdateFormView.as_view(), name='static_dataset_entry'),
    path('data-subsets/<resource_id>/update', views.CatalogueDataSubsetUpdateFormView.as_view(), name='data_subset'),
