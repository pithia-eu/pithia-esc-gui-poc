...
urlpatterns = [
    ...
    path('data-collections/<resource_id>/update/interaction-methods', views.DataCollectionInteractionMethodsUpdateView.as_view(), name='data_collection_interaction_methods'),
    path('static-dataset-entries/<resource_id>/update', views.StaticDatasetEntryUpdateFormView.as_view(), name='static_dataset_entry'),
