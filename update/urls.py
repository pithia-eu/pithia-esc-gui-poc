...
urlpatterns = [
    ...
    path('acquisition-capabilities/<acquisition_capability_id>/update/', views.AcquisitionCapabilitiesUpdateFormView.as_view(), name='acquisition_capability'),
    path('acquisitions/<acquisition_id>/update/', views.AcquisitionUpdateFormView.as_view(), name='acquisition'),
    path('computation-capabilities/<computation_capability_id>/update/', views.ComputationCapabilitiesUpdateFormView.as_view(), name='computation_capability'),
