                ...
                <div class="d-flex flex-column flex-grow-1">
                    <div class="pb-3">
                        <div class="d-flex align-items-center w-100">
                            ...
                            <button id="btn-rm-file-${metadataFile.id}" class="btn btn-outline-dark btn-outline-dark-togglable btn-sm btn-rm-file" data-list-item-num="${metadataFile.id}" type="button">
