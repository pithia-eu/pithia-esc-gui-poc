...
urlpatterns = [
    ...
    path('acquisition-capabilities/', views.acquisitions.as_view(), name='acquisition_capabilities'),
    path('acquisitions/', views.acquisitions.as_view(), name='acquisitions'),
    path('computation-capabilities/', views.computations.as_view(), name='computation_capabilities'),
