...
urlpatterns = [
    ...
    path('static-dataset-related-metadata/', views.catalogue_related_metadata_index, name='catalogue_related_metadata_index'),
    ...
    path('catalogues/', views.StaticDatasetManagementListView.as_view(), name='catalogues'),
