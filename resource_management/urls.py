...
urlpatterns = [
    ...
    path('acquisition-capabilities/', views.AcquisitionCapabilitiesManagementListView.as_view(), name='acquisition_capabilities'),
    path('acquisitions/', views.AcquisitionManagementListView.as_view(), name='acquisitions'),
    path('computation-capabilities/', views.ComputationCapabilitiesManagementListView.as_view(), name='computation_capabilities'),
