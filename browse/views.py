...
def static_dataset_tree(request):
    ...
    return render(request, 'browse/static_dataset_tree.html', {
        ...
        'data_subset_count': models.DataSubset.objects.count(),
        'data_subset_type_readable': models.DataSubset.type_readable,
        'data_subset_type_plural_readable': models.DataSubset.type_plural_readable,
