...
urlpatterns = [
    ...
    path('catalogues/', views.static_dataset_tree, name='static_dataset_tree'),
    ...
    path('catalogues/<static_dataset_id>/', views.StaticDatasetDetailView.as_view(), name='static_dataset_detail'),
