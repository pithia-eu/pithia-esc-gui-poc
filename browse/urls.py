...
urlpatterns = [
    ...
    path('acquisition-capabilities/', views.AcquisitionCapabilitiesListView.as_view(), name='list_acquisition_capabilities'),
    path('acquisitions/', views.AcquisitionListView.as_view(), name='list_acquisitions'),
    path('computation-capabilities/', views.ComputationCapabilitiesListView.as_view(), name='list_computation_capabilities'),
    ...
    path('acquisition-capabilities/<acquisition_capability_id>/', views.AcquisitionCapabilitiesDetailView.as_view(), name='acquisition_capability_detail'),
    path('acquisitions/<acquisition_id>/', views.AcquisitionDetailView.as_view(), name='acquisition_detail'),
    path('computation-capabilities/<computation_capability_id>/', views.ComputationCapabilitiesDetailView.as_view(), name='computation_capability_detail'),
    ...
    path('catalogue-entries/<catalogue_entry_id>/', views.catalogue_entry_detail.as_view(), name='catalogue_entry_detail'),
    path('catalogue-data-subsets/<catalogue_data_subset_id>/', views.catalogue_data_subset_detail.as_view(), name='catalogue_data_subset_detail'),
]
