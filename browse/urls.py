...
urlpatterns = [
    ...
    path('acquisition-capabilities/<acquisition_capability_id>/', views.AcquisitionCapabilitiesDetailView.as_view(), name='acquisition_capability_set_detail'),
    path('acquisitions/<acquisition_id>/', views.AcquisitionDetailView.as_view(), name='acquisition_detail'),
    path('computation-capabilities/<computation_capability_id>/', views.ComputationCapabilitiesDetailView.as_view(), name='computation_capability_set_detail'),
