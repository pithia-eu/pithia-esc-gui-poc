...
urlpatterns = [
    ...
    path('static-dataset-entries/<static_dataset_entry_id>/', views.CatalogueEntryDetailView.as_view(), name='static_dataset_entry_detail'),
    path('data-subsets/<data_subset_id>/', views.CatalogueDataSubsetDetailView.as_view(), name='data_subset_detail'),
