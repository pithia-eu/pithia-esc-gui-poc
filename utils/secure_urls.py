...
urlpatterns = [
    ...
    path('static-dataset-entries/<resource_id>/xml/', secure_views.CatalogueEntryXmlDownloadFromManagementView.as_view(), name='view_static_dataset_entry_as_xml_with_editing'),
    path('data-subsets/<resource_id>/xml/', secure_views.CatalogueDataSubsetXmlDownloadFromManagementView.as_view(), name='view_data_subset_as_xml_with_editing'),
