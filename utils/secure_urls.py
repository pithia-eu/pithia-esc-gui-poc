...
urlpatterns = [
    ...
    path('catalogue-entries/<resource_id>/xml/', secure_views.CatalogueEntryXmlDownloadFromManagementView.as_view(), name='view_static_dataset_entry_as_xml_with_editing'),
