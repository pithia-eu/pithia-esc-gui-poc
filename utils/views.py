...
from search.ontology_helpers import get_graph_of_pithia_ontology_component
...
def _convert_ontology_server_urls_to_browse_urls(ontology_server_urls):
    ...
    for ontology_server_url in ontology_server_urls:
        ...
        if ontology_term_category in ontology_server_url:
            graph_for_ontology_term = ontology_server_url[ontology_term_category]
        else:
...
def _convert_resource_server_urls_to_browse_urls(resource_server_urls):
...
def get_esc_url_templates_for_ontology_server_urls_and_resource_server_urls(request):
    ...
    esc_ontology_urls = _convert_ontology_server_urls_to_browse_urls(ontology_server_urls)
    esc_resource_urls = _convert_resource_server_urls_to_browse_urls(resource_server_urls)
