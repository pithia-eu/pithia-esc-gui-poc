...
urlpatterns = [
    ...
    path('static-datasets/<resource_id>/xml/', views.StaticDatasetXmlDownloadFromBrowsingView.as_view(), name='view_static_dataset_as_xml'),
    path('static-dataset-entries/<resource_id>/xml/', views.StaticDatasetEntryXmlDownloadFromBrowsingView.as_view(), name='view_static_dataset_entry_as_xml'),
    path('data-subsets/<resource_id>/xml/', views.DataSubsetXmlDownloadFromBrowsingView.as_view(), name='view_data_subset_as_xml'),
