...
urlpatterns = [
    ...
    path('acquisition_capabilities/<acquisition_capability_id>/xml', views.view_acquisition_capability_as_xml.as_view(), name='view_acquisition_capability_as_xml'),
    ...
    path('computation_capabilities/<computation_capability_id>/xml', views.view_computation_capability_as_xml.as_view(), name='view_computation_capability_as_xml'),
    path('processs/<process_id>/xml', views.view_process_as_xml.as_view(), name='view_process_as_xml'),
    path('data_collections/<data_collection_id>/xml', views.view_data_collection_as_xml.as_view(), name='view_data_collection_as_xml'),
]
