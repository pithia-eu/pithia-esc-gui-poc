...
urlpatterns = [
    ...
    path('acquisition-capabilities/<acquisition_capability_set_id>/xml', views.AcquisitionCapabilitiesXmlDownloadView.as_view(), name='view_acquisition_capability_as_xml'),
    path('acquisitions/<acquisition_id>/xml', views.AcquisitionXmlDownloadView.as_view(), name='view_acquisition_as_xml'),
    path('computation-capabilities/<computation_capability_set_id>/xml', views.ComputationCapabilitiesXmlDownloadView.as_view(), name='view_computation_capability_as_xml'),
