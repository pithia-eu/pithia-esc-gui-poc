...
urlpatterns = [
    ...
    path('acquisition_capabilitys/<acquisition_capability_id>/xml', views.view_acquisition_capability_as_xml.as_view(), name='view_acquisition_capability_as_xml'),
    ...
    path('computation_capabilitys/<computation_capability_id>/xml', views.view_computation_capability_as_xml.as_view(), name='view_computation_capability_as_xml'),
