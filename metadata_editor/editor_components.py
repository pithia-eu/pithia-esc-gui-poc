...
class BaseMetadataEditorComponent:
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        self.root_tag = root_tag
        self.nsmap_extensions = {}
        self.add_nsmap_extensions(nsmap_extensions)

    def add_nsmap_extensions(self, nsmap_extensions):
        return self.nsmap_extensions.update(nsmap_extensions)

    def initialise_xml_root(self):
    ...
    def add_properties_to_xml_document(self, properties: dict):
        self.initialise_xml_root()
...
class IdentifierMetadataEditorComponent(BaseMetadataEditorComponent):
...
class NameMetadataEditorComponent(BaseMetadataEditorComponent):
    def append_name(self, name):
        name_element = etree.SubElement(self.root, 'name')
        name_element.text = name

class DescriptionMetadataEditorComponent(BaseMetadataEditorComponent):
    def append_description(self, description=''):
        description_element = etree.SubElement(self.root, 'description')
        description_element.text = description


class LocationMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
...
class CapabilitiesMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
...
class StandardIdentifierComponent(BaseMetadataEditorComponent):
...
class CapabilityLinksMetadataEditorComponent(StandardIdentifierComponent, BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
            NamespacePrefix.GML: Namespace.GML,
            NamespacePrefix.XLINK: Namespace.XLINK,
...
class CitationPropertyTypeMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
    ...
    def _append_citation(self, parent_element, citation_properties, element_name):
        # Since CI_DateTypeCode 
        # If no title, date, identifier, other citation details, online resource
        if (not any([
            citation_properties.get('citation_title'),
            citation_properties.get('citation_date'),
            citation_properties.get('other_citation_details'),
            citation_properties.get('doi'),
            citation_properties.get('ci_linkage_url'),
        ])):
            return

        # Container elements
        citation_container_element = etree.SubElement(parent_element, element_name)
        citation_element = etree.SubElement(citation_container_element, 'Citation')

        # GMD title - required
        gmd_title_element = etree.SubElement(citation_element, '{%s}title' % Namespace.GMD)
        self._append_gco_character_string_sub_element(gmd_title_element, citation_properties.get('citation_title'))
        ...
        gco_date_element.text = citation_properties.get('citation_date')
        ...
        ci_date_type_code_element = etree.SubElement(ci_date_date_type_element, 'CI_DateTypeCode', codeList=citation_properties.get('ci_date_type_code_code_list'), codeListValue=citation_properties.get('ci_date_type_code_code_list_value'))
        # Date type code is normally 'Publication date'.
        ci_date_type_code_element.text = citation_properties.get('ci_date_type_code')

        # Identifier (DOI)
        if citation_properties.get('doi'):
            ...
            code_element = etree.SubElement(md_identifier_element, 'code')
            self._append_gco_character_string_sub_element(code_element, citation_properties.get('doi'))

        # GMD other citation details
        if citation_properties.get('other_citation_details'):
            gmd_other_citation_details_element = etree.SubElement(citation_element, '{%s}otherCitationDetails' % Namespace.GMD)
            self._append_gco_character_string_sub_element(gmd_other_citation_details_element, citation_properties.get('other_citation_details'))

        # Online Resource
        if citation_properties.get('ci_linkage_url'):
            ...
            url_element.text = citation_properties.get('ci_linkage_url')


class ContactInfoMetadataEditorComponent(BaseMetadataEditorComponent):
    ...
    def append_contact_info(self, contact_info):
        ...
        ci_contact_element = etree.SubElement(contact_info_element, 'CI_Contact', xmlns=Namespace.GMD)
...
class DataLevelMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
            NamespacePrefix.XLINK: Namespace.XLINK,
            **nsmap_extensions,
...
class DocumentationMetadataEditorComponent(CitationPropertyTypeMetadataEditorComponent):
    def append_documentation(self, documentation):
        self._append_citation(self.root, documentation, 'documentation')


class GCOCharacterStringMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
            NamespacePrefix.GCO: Namespace.GCO,
            **nsmap_extensions,
    ...
    def _append_gco_character_string_sub_element(self, parent_element, text):
        gco_character_string_element = etree.SubElement(parent_element, '{%s}CharacterString' % Namespace.GCO)
        gco_character_string_element.text = text


class GMLTimePeriodMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
            NamespacePrefix.GML: Namespace.GML,
            **nsmap_extensions,
...
class InputOutputMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
...
class QualityAssessmentMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
            NamespacePrefix.XLINK: Namespace.XLINK,
            **nsmap_extensions,
...
class RelatedPartyMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
            NamespacePrefix.XLINK: Namespace.XLINK,
            **nsmap_extensions,
...
class ShortNameMetadataEditorComponent(BaseMetadataEditorComponent):
...
class SourceMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
            NamespacePrefix.GMD: Namespace.GMD,
            NamespacePrefix.XLINK: Namespace.XLINK,
...
class StatusMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
            NamespacePrefix.XLINK: Namespace.XLINK,
            **nsmap_extensions,
...
class TypeMetadataEditorComponent(BaseMetadataEditorComponent):
    def __init__(self, root_tag, nsmap_extensions={}) -> None:
        super().__init__(root_tag, nsmap_extensions={
            NamespacePrefix.XLINK: Namespace.XLINK,
            **nsmap_extensions,
