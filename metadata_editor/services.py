...
class OrganisationMetadataEditor(
    ContactInfoMetadataEditorComponent,
    DescriptionMetadataEditorComponent,
    GCOCharacterStringMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
    NameMetadataEditorComponent,
    ShortNameMetadataEditorComponent):
    def __init__(self) -> None:
        super().__init__(Organisation.root_element_name)

    def add_properties_to_xml_document(self, properties: dict):
        super().add_properties_to_xml_document(properties)
        self.append_identifier(
            properties['localid'],
            properties['namespace'],
            properties['identifier_version']
        )
...
class IndividualMetadataEditor(
    ContactInfoMetadataEditorComponent,
    DescriptionMetadataEditorComponent,
    GCOCharacterStringMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
...
class ProjectMetadataEditor(
    DescriptionMetadataEditorComponent,
    DocumentationMetadataEditorComponent,
    GCOCharacterStringMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
    NameMetadataEditorComponent,
    RelatedPartyMetadataEditorComponent,
    ShortNameMetadataEditorComponent,
    StatusMetadataEditorComponent):
    def __init__(self) -> None:
...
class PlatformMetadataEditor(
    DescriptionMetadataEditorComponent,
    DocumentationMetadataEditorComponent,
    GCOCharacterStringMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
    LocationMetadataEditorComponent,
    NameMetadataEditorComponent,
    RelatedPartyMetadataEditorComponent,
    ShortNameMetadataEditorComponent,
    StandardIdentifierComponent,
    TypeMetadataEditorComponent):
    def __init__(self) -> None:
...
class OperationMetadataEditor(
    DescriptionMetadataEditorComponent,
    DocumentationMetadataEditorComponent,
    GCOCharacterStringMetadataEditorComponent,
    GMLTimePeriodMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
    LocationMetadataEditorComponent,
    NameMetadataEditorComponent,
    RelatedPartyMetadataEditorComponent,
...
class InstrumentMetadataEditor(
    DescriptionMetadataEditorComponent,
    DocumentationMetadataEditorComponent,
    GCOCharacterStringMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
...
class AcquisitionCapabilitiesMetadataEditor(
    CapabilitiesMetadataEditorComponent,
    DataLevelMetadataEditorComponent,
    DescriptionMetadataEditorComponent,
    DocumentationMetadataEditorComponent,
    GCOCharacterStringMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
    InputOutputMetadataEditorComponent,
    NameMetadataEditorComponent,
    QualityAssessmentMetadataEditorComponent,
    RelatedPartyMetadataEditorComponent):
    def __init__(self) -> None:
...
class AcquisitionMetadataEditor(
    CapabilityLinksMetadataEditorComponent,
    DescriptionMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
    NameMetadataEditorComponent):
...
class ComputationCapabilitiesMetadataEditor(
    CapabilitiesMetadataEditorComponent,
    DataLevelMetadataEditorComponent,
    DescriptionMetadataEditorComponent,
    DocumentationMetadataEditorComponent,
...
class ComputationMetadataEditor(
    CapabilityLinksMetadataEditorComponent,
    DescriptionMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
    NameMetadataEditorComponent):
    ...
    def __init__(self) -> None:
        super().__init__(Computation.root_element_name)
...
class DataCollectionMetadataEditor(
    DataLevelMetadataEditorComponent,
    DescriptionMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
    NameMetadataEditorComponent,
...
class CatalogueEntryMetadataEditor(
    DescriptionMetadataEditorComponent,
    GMLTimePeriodMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
    NameMetadataEditorComponent):
    ...
    def add_properties_to_xml_document(self, properties: dict):
        ...
        self.append_name(properties['entry_name'])
        self.append_description(properties['entry_description'])
        self.append_phenomenon_time(properties['phenomenon_time'])


class CatalogueDataSubsetMetadataEditor(
    DataLevelMetadataEditorComponent,
    DescriptionMetadataEditorComponent,
    GMLTimePeriodMetadataEditorComponent,
    IdentifierMetadataEditorComponent,
    ...
    def append_name(self, name):
        ...
        data_subset_name_element.text = name

    def append_description(self, description=''):
        data_subset_description_element = etree.SubElement(self.root, 'dataSubsetDescription')
        data_subset_description_element.text = description
    ...
    def add_properties_to_xml_document(self, properties: dict):
        ...
        self.append_name(properties['data_subset_name'])
        self.append_description(properties['data_subset_description'])
